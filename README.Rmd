...
Go from a 3-column format events file (i.e., onset, duration, trial_type) and a physiological time series from a region of interest to a PPI design matrix in under **4** seconds!
