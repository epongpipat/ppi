...
y <- cbind(data_wrangled_right$phys_var$input, data_wrangled_left$phys_var$input)
X <- list(data_wrangled_right$design_matrix, data_wrangled_left$design_matrix)
model_l1 <- model_glm_roi2roi(y, X)
