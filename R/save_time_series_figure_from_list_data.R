#' @title save_time_series_figure_from_list_data
#' @concept helper
...
#'
#' @examples
save_time_series_figure_from_list_data <- function(data, out_dir, out_prefix = NULL, out_suffix = NULL, scales = NULL, nrow = NULL, ncol = NULL, width = NA, height = NA, units = "in") {
