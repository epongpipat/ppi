#' @title save_time_series_heatmap_figure_from_list_data
#' @concept helper
...
#'
#' @examples
save_time_series_heatmap_figure_from_list_data <- function(data, out_dir, out_prefix = NULL, out_suffix = NULL, transpose = FALSE, width = NA, height = NA, units = "in") {
